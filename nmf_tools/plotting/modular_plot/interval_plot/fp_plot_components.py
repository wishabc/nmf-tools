...
from nmf_tools.plotting.modular_plot.interval_plot.fp_loaders import PosteriorLoader, AnnotateWithDHSLoader, FootprintDatasetLoader, ProtectedNucleotidesLoader
from nmf_tools.plotting.modular_plot.interval_plot.basic_loaders import FastaLoader

from genome_tools.plotting.sequence import seq_plot

@uses_loaders(PosteriorLoader, AnnotateWithDHSLoader)
...
# Just use usual squence plot with different loaders attached
